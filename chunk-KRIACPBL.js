...
} from "./chunk-RIHXEXQT.js";
import {
  isRTL
} from "./chunk-PUB3GHPY.js";
import {
  createLockController
} from "./chunk-4CSSF2RB.js";
import {
  findIonContent,
  getScrollElement,
  printIonContentErrorMsg
} from "./chunk-PVZIGEGI.js";
import "./chunk-LDPYMOK4.js";
import "./chunk-Y7OS77E4.js";
import {
  getTimeGivenProgression
} from "./chunk-ISTD6JLQ.js";
import {
  attachComponent,
  detachComponent
} from "./chunk-4WXECVQ3.js";
import {
  createColorClasses,
  hostContext
...
} from "./chunk-SKCF6BBS.js";
import "./chunk-MXVMIXMS.js";
import {
  Host,
  config,
  createEvent,
  ...
  componentDidLoad() {
    {
      rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./chunk-45VKZPYU.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./chunk-IMAJE62V.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./chunk-SNC5ZHNB.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./chunk-Y2T7HGIJ.js");
        ...
        if (typeof window !== "undefined") {
          import("./chunk-7BQORWJF.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./chunk-PBROHCRF.js").then((module) => this.focusVisible = module.startFocusVisible());
      }));
    }
  }
  /**
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./chunk-4Z5NMD6G.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
